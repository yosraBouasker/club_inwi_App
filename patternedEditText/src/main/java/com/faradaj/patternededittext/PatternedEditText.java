...
public class PatternedEditText extends EditText {
    ...
    private static String mRawText = "";
    ...
    public Parcelable onSaveInstanceState() {
        ...
        PetSavedState ss = new PetSavedState(superState);
        ss.setRealText(mRawText);
        return ss;
    }

    @Override
    public void onRestoreInstanceState(Parcelable state) {
        if(!(state instanceof PetSavedState)) {
        ...
        setText(mRawText, BufferType.EDITABLE);
    ...
    public static class PetSavedState extends BaseSavedState implements Parcelable {
