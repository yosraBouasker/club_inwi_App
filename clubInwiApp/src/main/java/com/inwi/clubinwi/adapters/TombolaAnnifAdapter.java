...
import com.inwi.clubinwi.fragments.TombolaAnnifFragment;
...
public class TombolaAnnifAdapter extends RecyclerView.Adapter<TombolaAnnifAdapter.TombolaViewHolder> {

    private List<Tombola> tombolas;
    private Context mContext;

    public TombolaAnnifAdapter(Context context, ArrayList<Tombola> tombolas) {
    ...
    public TombolaViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_tombola_annif, parent, false);
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (object.getString("header").equals("OK")) {
                        ...
                        ft.replace(R.id.content, new TombolaAnnifFragment());
