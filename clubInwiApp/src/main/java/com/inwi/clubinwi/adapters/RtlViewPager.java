 ...
 */
        ...
        try{
        Parcelable mvps =  in.readParcelable(loader);
        int mld  = in.readInt();
        //read = true ;

        }
        catch (Exception e){
                Log.e("error reading parcel",e.getMessage());
        }
       ...
       // if(read){
        ...
        //}
        /*else {mViewPagerSavedState = null;
                mLayoutDirection = 0;}*/
        ...
        // before
  /*      @Override
        public void MvpLceViewStateActivit(Parcelable state) {
                if (!(state instanceof SavedState)) {
                        super.onRestoreInstanceState(state);
                        return;
                }
